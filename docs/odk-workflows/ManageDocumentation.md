...
The documentation for OPENLHS-IMPORTS is managed in two places (relative to the repository root):
...
1. In your terminal, navigate to the edit directory of your ontology, e.g.:
   ```
   cd OpenLHS-Imports/src/ontology
   ```
2. Now you are ready to build the docs as follows:
   ...
   ```
   INFO    -  Your documentation should shortly be available at: https://OpenLHS.github.io/OpenLHS-Imports/ 
   ```
3. Just to double check, you can now navigate to your documentation pages (usually https://OpenLHS.github.io/OpenLHS-Imports/). 
